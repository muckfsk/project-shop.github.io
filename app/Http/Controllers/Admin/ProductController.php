...
class ProductController extends Controller
{
    ...
    public function productGalleryDelete($id)
    {
        ...
        return redirect()->route('admin.products.edit', $gallery->product_id)->with('success', 'Data Produk Berhasil Dihapus');
    }
    ...
    public function productGalleryUpload(Request $request)
    {
        ...
        ProductGallery::create($data);
        return redirect()->route('admin.products.edit', $request->product_id)->with('success', 'Data Gambar Berhasil Ditambahkan');
    }
}
